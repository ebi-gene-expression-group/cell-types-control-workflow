...
process fetch_data{
    ...
    """
    get_input_data.R\
            --reference-mat-url ${params.data_download.reference_mat_url}\
            --reference-barcodes-url ${params.data_download.reference_barcodes_url}\
            --reference-genes-url ${params.data_download.reference_genes_url}\
            --query-matrix-url ${params.data_download.query_matrix_url}\
            --query-barcodes-url ${params.data_download.query_barcodes_url}\
            --query-genes-url ${params.data_download.query_genes_url}\
            --reference-metadata ${params.data_download.reference_metadata}\
